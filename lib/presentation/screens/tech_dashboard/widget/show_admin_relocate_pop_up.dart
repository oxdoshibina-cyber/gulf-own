...
class ShowAdminRelocatePopUp extends StatefulWidget {
  final int siEntryNo;
  final int asId;
  const ShowAdminRelocatePopUp({
    super.key,
  ...
  @override
  State<ShowAdminRelocatePopUp> createState() => _ShowAdminRelocatePopUpState();
}

class _ShowAdminRelocatePopUpState extends State<ShowAdminRelocatePopUp> {
